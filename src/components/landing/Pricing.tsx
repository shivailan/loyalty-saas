...
export function Pricing() {
  return (
    <section id="tarifs" className="bg-neutral-800 py-24">
      <div className="mx-auto max-w-md px-6 text-center">
        ...
        <Reveal delay={0.1}>
          <div className="mt-10 rounded-2xl border border-white/10 bg-white/5 p-8 text-left shadow-xl backdrop-blur-sm transition-colors hover:bg-white/[0.07]">
